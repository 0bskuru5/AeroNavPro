    ...
    <script type="text/javascript" src="admin/assets/js/select2.min.js"></script>
     ...
     <link rel="stylesheet" href="ass/css/bootstrap.min.css">
      ...
      <!-- fevicon -->
      <link rel="icon" href="ass/images/fevicon.png" type="image/gif" />
      <!-- Scrollbar Custom CSS -->
      <link rel="stylesheet" href="ass/css/jquery.mCustomScrollbar.min.css">
      <!-- Tweaks for older IEs-->
      <!-- owl stylesheets --> 
      <link rel="stylesheet" href="ass/css/owl.carousel.min.css">
      <link rel="stylesheet" href="ass/css/owl.theme.default.min.css">
      <!--[if lt IE 9]>
