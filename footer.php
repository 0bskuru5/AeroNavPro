  ...
  $(document).ready(function(){
    load_cart()
     $('#preloader').fadeOut('fast', function() {
      ...
      <script src="ass/js/jquery-3.0.0.min.js"></script>
      <script src="ass/js/plugin.js"></script>
      <!-- sidebar -->
      <script src="ass/js/jquery.mCustomScrollbar.concat.min.js"></script>
      <script src="ass/js/custom.js"></script>
      <!-- javascript --> 
      <script src="ass/js/owl.carousel.js"></script>
      <script>
         $(document).ready(function() {
